...
prior <- c(
  ...
  prior(student_t(3, 0, 2.5), class = "sd", resp = "new"),
  prior(student_t(3, 0, 2.5), class = "sd", resp = "believe"),
  prior(student_t(3, 0, 2.5), class = "sd", resp = "relevant"),
  prior(student_t(3, 0, 2.5), class = "sd", resp = "drinkless")
)
...
mod1 <- brm(bf.new + 
            ...
            cores = cores)
t2 <- Sys.time()
saveRDS(mod1,"GDS_brms_multi_multi_data9.RDS")
tmod <- t2 - t1
tmod
